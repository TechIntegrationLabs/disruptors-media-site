    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Work</h1>
                <!--end::Title-->
                <!--begin::Separator-->
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                <!--begin::Form-->
                <form id="updateHeaderForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('update_work_portfolios',['id'=>$project->id])}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                <input type="text" class="form-control form-control-solid" name="project_name" id="project_name" placeholder="Enter Project Name" value="{{$project->portfolio_name}}">
                               ...
                               @foreach ($projects_categories as $projects_category)
                                <label class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input h-20px w-20px" 
                                           ...
                                           value="{{ $projects_category->id }}" 
                                           {{ in_array($projects_category->id, explode(',', $project->category_id)) ? 'checked' : '' }}>
...
<div class="row mb-8" id="text_fields">
    ...
    <div class="col-xl-9 fv-row fv-plugins-icon-container tag-container">
        @php
            $tags = explode(',', $project->portfolio_tags); // Assuming $portfolio is your portfolio object
        @endphp
        @foreach($tags as $tag)
            <div class="input-group mb-3">
                <input type="text" class="form-control form-control-solid" name="tags[]" value="{{ $tag }}" placeholder="Enter Tag">
                ...
                <img src="{{ asset('assets/media/plus.png') }}"/></a>
                       ...
                       <div class="row mb-8" id="text_fields">
                        ...
                        <div class="col-xl-9 fv-row fv-plugins-icon-container team-container">
                            @php
                                $teams = explode(',', $project->team_description); // Assuming $portfolio is your portfolio object
                            @endphp
                            @foreach($teams as $team)
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-solid" name="teams[]" value="{{ $team }}" placeholder="Enter Teams">
                                    
                                </div>
                            @endforeach
                            <div class="fv-plugins-message-container invalid-feedback">
                                <a href="javascript:void(0);" class="add_team" title="Add Team Content">
                                    <img src="{{ asset('assets/media/plus.png') }}"/></a>
                            </div>
                        </div>
                    </div>
                           ...
                           <div class="row mb-5">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('{{asset('/'.$project->portfolio_image)}}')"></div>
                         ...
                         <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                <!-- Existing Images from ProjectImages table -->
                                    ...
                                    @php
                                        $images = \App\Models\Portfolio_Images::where('portfolio_id', $project->id)->get();
                                    @endphp
                                    @foreach($images as $image)
                                        <div class="existing-image">
                                            <img class="mb-3" style="width:120px;" src="{{ asset('/'.$image->portfolio_images) }}" alt="Existing Image">
                                            <!-- Add a delete button or checkbox here -->
                                            <!-- For example, a delete button -->
                                            <a href="{{ route('delete_img', ['id' => $image->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
