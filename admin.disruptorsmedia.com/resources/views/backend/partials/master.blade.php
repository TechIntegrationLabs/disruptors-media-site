...
<html lang="en">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/fslightbox@2.9.0/dist/fslightbox.min.css">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<a href="{{ route('admindashboard') }}">
							<img alt="Logo" src="{{ asset('assets/media/logo-menu.png') }}" class="logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
						<!--end::Aside toggler-->
					...
					<div class="aside-menu flex-column-fluid">
						<!--begin::Aside Menu-->
						<div class="hover-scroll-overlay-y my-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							<!--begin::Menu-->
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title big">General Settings</span>
									</span>
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="{{ route('edit_header_settings') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Header Configuration</span>
											</a>
										</div>
                                        <div class="menu-item">
											<a class="menu-link" href="{{route('edit_footer_settings')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('list_menu_manager') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Navigation Management</span>
											</a>
										</div>
                                        <div class="menu-item">
											<a class="menu-link" href="{{ route('list_social_media_links') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Add New Social Media Channels</span>
											</a>
										</div>
										 <div class="menu-item">
											<a class="menu-link" href="{{ route('create_social_media_links_cat') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Social Media Integration</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{ route('featured_clients_list') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Client Showcase</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{ route('faqs_list') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('get_a_quote') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('what_We_do_list') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Services Frames</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{ route('list_gallery') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Project Galleries</span>
											</a>
										</div>
									</div>
								</div>
								<div class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title big">Pages</span>
									</span>
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link" href="{{route('view_home_page')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Main Page Setup</span>
											</a>
										</div>
											<div class="menu-item">
											<a class="menu-link" href="{{ route('list_work_project_cateogories') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Work Categories Management</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{ route('list_work_projects') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Work Portfolio </span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{route('create_about_us')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('edit_service_page_settings') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('view_contact_page') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<span class="menu-link">
										...
										<span class="menu-title big">Seo & Technical</span>
									</span>
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link" href="{{route('seo_script_list')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
											...
											<div class="menu-item">
											<a class="menu-link" href="{{route('edit_website_meta')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Site-wide SEO Settings</span>
											</a>
										</div>
								...
								<div class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title big">Podcast</span>
									</span>
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link" href="{{route('podcast_video_lists')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{route('view_podcast_content')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Podcast Content</span>
											</a>
										</div>
										
											<div class="menu-item">
											<a class="menu-link" href="{{route('list_studios')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="{{ route('admindashboard') }}" class="d-lg-none">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img src="{{ asset('assets/media/logos/logo.svg') }}" alt="user" />
										</div>
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="d-flex flex-column">
														<div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::user()->username }}<br>
														<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ config('app.name'); }}<br></span></div>
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<a href="{{ config('app.url') }}">{{ config('app.name'); }}</a></div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-1.10.12/datatables.min.js"></script>
    ...
    forced_root_block: false, // Disable automatic <p> tag insertion
    force_br_newlines: true, // Convert new lines to <br>
    force_p_newlines: false, // Disable <p> tag insertion for new lines
    convert_newlines_to_brs: true, // Convert new lines to <br> on paste
    plugins: "advlist autolink link image lists charmap print preview code"
});

tinymce.init({
    selector: "#footer_right_side_address",
    height: "480",
    menubar: false,
    toolbar: ["styleselect fontselect fontsizeselect",
        "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
...
tinymce.init({
    selector: "#services_page_second_section_main_content",
    height: "480",
    menubar: false,
    toolbar: ["styleselect fontselect fontsizeselect",
        "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
...
tinymce.init({
    selector: "#services_page_box_inner_content",
    height: "480",
    menubar: false,
    toolbar: ["styleselect fontselect fontsizeselect",
        "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
    ...
    tinymce.init({
        selector: "#section_one_sub_heading",
        height: "480",
        menubar: false,
        toolbar: ["styleselect fontselect fontsizeselect",
            "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
	...
	tinymce.init({
        selector: "#about_this_space_content",
        height: "480",
        menubar: false,
        toolbar: ["styleselect fontselect fontsizeselect",
            "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
    ...
    //   tinymce.init({
    //     selector: "#google_search_console",
    //     height: "480",
    //     menubar: false,
    //     toolbar: ["styleselect fontselect fontsizeselect",
    //         "undo redo | cut copy paste | bold italic | link image | alignleft aligncenter alignright alignjustify",
